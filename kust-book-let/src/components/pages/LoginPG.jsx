    ...
    <div onSubmit={handleForm} className='flex justify-center items-center mt-[45%] md:mt-48'>
      ...
      <form  className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 border">
        ...
        <div className="mb-6">
          ...
          <input onChange={handleNamePassword} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="******************" />
        </div>

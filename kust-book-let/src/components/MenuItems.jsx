...
export const MenuItems = ({handleNavbar, active}) => {
  return (
    <ul className={active ? 'flex flex-col  items-start p-3 fixed inset-0 left-[55%] uppercase h-[15rem] bg-[#F5F5F5] gap-1 ease-in-out duration-500 border-2 sm:hidden' : 'hidden'}>
      <RxCross1 onClick={handleNavbar} className=' mt-7 ml-40 right-0 text-[#000000] font-medium text-[14px] leading-5 not-italic'/>
